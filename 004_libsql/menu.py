    ...
    def user_submenu_selection(self):
        while True:
            ...
            if "1" == key:
                ...
                self.enter_submenu(user_list)
                self.manager.libDB.update_user_active(
                    input("Id of user to activate: "), True
                )
                input(">> ")
                self.exit_submenu()
            elif "0" == key:
    ...
    def book_submenu_selection(self):
        while True:
            ...
            if "1" == key:
                ...
                self.enter_submenu(book_list)
                try:
                    self.manager.bookDB.remove_book(
                        int(input("Id of book to remove: "))
                    )
    ...
    def category_submenu_selection(self):
        while True:
            ...
            if "1" == key:
                ...
                self.enter_submenu(category_list)
                try:
                    self.manager.categoryDB.remove_category(
                        int(input("Id of category to remove: "))
                    )
